...
# Create listings
listing_one = Listing.new(:headline => 'A very bad place', :description => "wet and cold in the wind of the cities waste dump winds", :address => " 3600 North Clark Street", :price_daily => 3.50 , :country => 'US', :city => 'Chicago', :capacity => 3, :user => user_one)
listing_one.save!
...
listing_five = Listing.new(:headline => 'A very interesting place', :description => "wet and cold in the wind of the cities waste dump winds", :address => '3735 West Diversey Avenue', :price_daily => 883.50 , :country => 'US', :city => 'Chicago', :capacity => 3, :user => user_one)
listing_five.save!
